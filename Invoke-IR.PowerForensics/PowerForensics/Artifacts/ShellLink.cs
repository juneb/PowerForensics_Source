...
namespace PowerForensics.Artifacts
{
    ...
    public class ItemId
    {
        ...
        internal ItemId(byte[] bytes, ref int offset)
        {
            ...
            Data = NativeMethods.GetSubArray(bytes, (uint)offset + 0x02, (uint)ItemIdSize - 0x02);
    ...
    public class KnownFolderDataBlock : ExtraData
    {
        ...
        internal KnownFolderDataBlock(byte[] bytes, int offset)
        {
            BlockSize = BitConverter.ToUInt32(bytes, offset);
            Name = (EXTRA_DATA_TYPE)BitConverter.ToUInt32(bytes, offset + 0x04);
            KnownFolderId = new Guid(NativeMethods.GetSubArray(bytes, (uint)offset + 0x08, 0x10));
    ...
    public class PropertyStoreDataBlock : ExtraData
    {
        ...
        internal PropertyStoreDataBlock(byte[] bytes, int offset)
        {
            BlockSize = BitConverter.ToUInt32(bytes, offset);
            Name = (EXTRA_DATA_TYPE)BitConverter.ToUInt32(bytes, offset + 0x04);
            PropertyStore = NativeMethods.GetSubArray(bytes, (uint)offset + 0x08, BlockSize - 0x08);
        }
    ...
    public class TrackerDataBlock : ExtraData
    {
        ...
        internal TrackerDataBlock(byte[] bytes, int offset)
        {
            ...
            Droid = new Guid[2];
            Droid[0] = new Guid(NativeMethods.GetSubArray(bytes, DroidOffset, 0x10));
            Droid[1] = new Guid(NativeMethods.GetSubArray(bytes, DroidOffset + 0x10, 0x10));
            #endregion Droid
            #region DroidBirth
            DroidBirth = new Guid[2];
            DroidBirth[0] = new Guid(NativeMethods.GetSubArray(bytes, DroidOffset + 0x20, 0x10));
            DroidBirth[1] = new Guid(NativeMethods.GetSubArray(bytes, DroidOffset + 0x30, 0x10));
