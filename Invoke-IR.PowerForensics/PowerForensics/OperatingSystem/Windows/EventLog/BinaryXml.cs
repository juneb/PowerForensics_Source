...
namespace PowerForensics.EventLog
{
    ...
    class BinXmlTemplateDefinition
    {
        ...
        internal BinXmlTemplateDefinition(byte[] bytes, int chunkOffset, int offset)
        {
            ...
            TemplateId = new Guid(NativeMethods.GetSubArray(bytes, (uint)dataoffset + 0x04, 0x10));
                ...
                for (int i = 0; i < ValueCount; i++)
                {
                    switch(ValueTypeArray[i].ValueType)
                    {
                        ...
                        case BinaryXml.VALUE_TYPE.GuidType:
                            ValueArray[i] = new Guid(NativeMethods.GetSubArray(bytes, (uint)offset, 0x10));
                            break;
    ...
    // Not Done
    class BinXmlContentStringData
    {
        #region Properties

        internal readonly BinXmlValueText ValueText;
        //internal readonly BinXmlSubstitution Substitution;

        #endregion Properties

        #region Constructors

        internal BinXmlContentStringData(byte[] bytes, int offset)
        {
    ...
    class BinXmlCharacterEntityReference
    {
        ...
        {
            Token = (BinaryXml.TOKEN_TYPE)bytes[offset];
            Value = NativeMethods.GetSubArray(bytes, (uint)offset + 0x01, 0x02);
        }
    ...
    class BinXmlPI
    {
        ...
        internal readonly BinXmlPITarget PITarget;
        internal readonly BinXmlPIData PIData;

        #endregion Properties

        #region Constructors

        internal BinXmlPI(byte[] bytes, int offset)
        {
    ...
    class BinXmlPITarget
    {
        ...
        internal BinXmlPITarget(byte[] bytes, int offset)
        {
    ...
    class BinXmlPIData
    {
        ...
        internal BinXmlPIData(byte[] bytes, int offset)
        {
