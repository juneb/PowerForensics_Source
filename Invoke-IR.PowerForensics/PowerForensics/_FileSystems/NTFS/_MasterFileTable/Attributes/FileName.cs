...
namespace InvokeIR.PowerForensics.NTFS
{
    ...
    public class FileName : Attr
    {
        ...
        public FileName(byte[] bytes)
        {
            ...
            AccessedTime = DateTime.FromFileTime(BitConverter.ToInt64(bytes, 32));
            ChangedTime = DateTime.FromFileTime(BitConverter.ToInt64(bytes, 16));
            BornTime = DateTime.FromFileTime(BitConverter.ToInt64(bytes, 8));
        }
        ...
        internal FileName(byte[] bytes, string attrName)
        {
            ...
            Namespace = Convert.ToInt32(fileName.NameSpace);
