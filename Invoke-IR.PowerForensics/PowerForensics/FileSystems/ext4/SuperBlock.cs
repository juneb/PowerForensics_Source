...
namespace InvokeIR.PowerForensics.ext4
{
    public class Superblock
    {
        ...
        internal Superblock(byte[] bytes)
        {
            ...
            MountTime = FromUnixTime(BitConverter.ToUInt32(bytes, 0x2C));
            WriteTime = FromUnixTime(BitConverter.ToUInt32(bytes, 0x30));
            ...
            LastCheckTime = FromUnixTime(BitConverter.ToUInt32(bytes, 0x40));
            ...
            FileSystemCreationTime = FromUnixTime(BitConverter.ToUInt32(bytes, 0x108));
            ...
            FirstErrorTime = FromUnixTime(BitConverter.ToUInt32(bytes, 0x198));
            ...
            LastErrorTime = FromUnixTime(BitConverter.ToUInt32(bytes, 0x1CC));
        ...
        private DateTime FromUnixTime(uint unixTime)
        {
